...
Input
В первой строке находятся три числа: n, m и k.
Во второй строке находятся числа xi для i=1,…,k, которые соответствуют номерам столбцов первой строки таблицы лабиринта, являющимся входами для i-го человека (первый столбец имеет номер 1).

В третьей строке находятся числа yi для i=1,…,k, которые соответствуют номерам столбцов последней строки таблицы лабиринта, являющимся выходами.

В следующих n строках задаются строки таблицы лабиринта: 0 — свободное место, 1 — стена.

Output
В первой строке выведите максимальное число людей, которое удалось провести.
